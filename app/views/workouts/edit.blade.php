...
<div class="container">
  {{ Form::model($workout, ['method' => 'put', 'action' => ['WorkoutsController@update', $workout->id], 'class' => 'form-horizontal']) }}
    ...
    <div class="form-group">
      {{ Form::label('metric', trans('workouts.metric.label'), array('class' => 'control-label col-md-2')) }}
      <div class="col-md-6">
    ...
    <div class="form-group">
      <div class="col-md-offset-2 col-md-6">
        {{ Form::submit(trans('messages.update.label'), array('class' => 'btn btn-lg btn-primary')) }}
      </div>
    </div>
  {{ Form::close() }}
</div>
